...
INSERT INTO `user` (`reg_date`, `email`, `name`, `password`, `avatar`, `contacts`) 
	VALUES  ('2018-09-19', 'rv@user.com', 'Роман Виноградов',  '$2y$10$cRGEYqUALDX4ilLUqoB1buH3.GtXECEwUgWywQ55cfYLP/yNrPXJC', 'img/user.jpg', 'rv@user.com'),
			('2018-09-20', 'va@user.com', 'Василий Арбузов',   '$2y$10$3y3cj1mmyo.nVxrrlCjrCOE3v4QnXgxSTu9KvatxDsM2Mw8GFsFDy', 'img/user.jpg', 'va@user.com'),
			('2018-09-20', 'mp@user.com', 'Максим Помидоркин', '$2y$10$wyLzLGpa8LP5Ob9funIcBeKoFdDxrXJhIUVEt6PXF9Yte1UTgp6H2', 'img/user.jpg', 'mp@user.com');
...
INSERT INTO `lot` (`creation_date`, `name`, `description`, `image_url`, `starting_price`, `closing_date`, `bid_step`, `author_id`, `winner_id`, `category_id`)
	VALUES  ('2018-09-21', '2014 Rossignol District Snowboard',                 'сноуборд 2014 года', 'img/lot-1.jpg', 10999,  '2018-10-17', 100, 1, NULL, 1),
	 		('2018-09-21', 'DC Ply Mens 2016/2017 Snowboard',                   'сноуборд',           'img/lot-2.jpg', 159999, '2018-10-17', 100, 1, NULL, 1),
	 		('2018-09-22', 'Крепления Union Contact Pro 2015 года размер L/XL', 'крепления',          'img/lot-3.jpg', 8000,   '2018-10-17', 100, 1, NULL, 2),
	 		('2018-09-23', 'Ботинки для сноуборда DC Mutiny Charocal',          'ботинки',            'img/lot-4.jpg', 10999,  '2018-10-17', 100, 2, NULL, 3),
	 		('2018-09-23', 'Куртка для сноуборда DC Mutiny Charocal',           'куртка',             'img/lot-5.jpg', 7500,   '2018-10-17', 100, 2, NULL, 4),
	 		('2018-09-23', 'Маска Oakley Canopy',                               'маска',              'img/lot-6.jpg', 5400,   '2018-10-17', 100, 2, NULL, 6);
